...
| <br> **_Additional notes:_** <br> | Wireshark is an excellent tool for network traffic analysis. The best part is that it is open-source and easy to use, thanks to its GUI. <br><br> |
...
| <br> _Additional notes:_ <br> | <br> Using `tcpdump` is very fun because I like typing shell commands to feel more in control of the instructions given to the program. <br><br> |
...
| <br> **_Additional notes:_** <br> | <br> The company must do more awareness campaigns and install filters. Also, the principle of least privilege must be more strongly enforced. <br><br><br |
...
| <br> **_Additional notes:_** <br> | <br> The company must ensure that execution permits are in accordance to the least privilege principle. Also, even more awareness campaigns to detect and report more phishing attacks. <br><br> |
...
This is the malicious email in question: 
